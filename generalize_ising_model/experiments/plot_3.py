...
path_simulation_output = ['/home/brainlab/Desktop/Rudas/Data/Ising/experiment_2/simulation/0_others/moreno_seventh_seventh',
                          ...
                          '/home/brainlab/Desktop/Rudas/Data/Ising/experiment_2/simulation/14_undirected_weighted_1.0/N_135',
...
for simulation in path_simulation_output:
    ...
    if os.path.isdir(simulation):
        ...
        results.append([np.mean(dimensionality_sim), np.mean(critical_temperature_sim), np.mean(size_sim), np.mean(degree_sim)])
...
for experiment in results:
    ...
    radar.plot([experiment[0]/f1, experiment[1]/f2, experiment[2]/f3, experiment[3]/f4],  "-", lw=2, color=color[cont], alpha=0.7, label=labels_[cont])
    radar.fill([experiment[0]/f1, experiment[1]/f2, experiment[2]/f3, experiment[3]/f4], color=color[cont], alpha=0.05)
    cont += 1
